...
<header>
  ...
  <button id="enBtn" aria-pressed="false" data-lang="en" onclick="(window.requestLangChange||function(l){document.dispatchEvent(new CustomEvent('requestLangChange',{detail:{lang:l}}));})('en')">EN</button>
    </div>
  </div>
</header>
`;
